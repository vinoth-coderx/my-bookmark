...
export function BookmarkIcon({ color = "white" }: { color?: string } = {}) {
  return (
    <svg
      width="16"
      height="16"
...
export function ExternalArrowIcon({ color }: { color: string }) {
  return (
    <svg
      width="14"
      height="14"
...
export function EyeIcon({ color = "currentColor" }: { color?: string } = {}) {
  return (
    <svg
      width="16"
      height="16"
